...
public class Office365TextMsgSend {
	...
	String USERNAME = "avanishas123_outlook.com#EXT#@avanishas123outlook.onmicrosoft.com";
	String PASSWORD = "Avanishkumar";
			//"XXXXXXXXXX";
	String HOSTNAME = "smtp.office365.com";
	String STARTTLS_PORT = "587";
	boolean STARTTLS = true;
	boolean AUTH = true;
	String FromAddress="avanishas123@office365.com";

	public static void main(String args[]) throws MessagingException {
		String EmailSubject = "Subject:Text Subject";
		String EmailBody = "Text Message Body: Hello World";
		String ToAddress = "avanish.as@office365.com";
